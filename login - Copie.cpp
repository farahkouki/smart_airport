...
bool login::Login(QString u, QString p)
{
   // ui->adminButton->setVisible(false);
    ...
    bool exists = false;
 QSqlQuery Query1;
 Query1.prepare("UPDATE login SET etat=:un where username= :username;");
  Query1.bindValue(":username",u );
 Query1.bindValue(":un", '1');
//Query1.exec();
    QSqlQuery Query;
...
void login::on_uplButton_clicked()
{
    ...
    ui->regLabel->setText("<img src=\"file:///"+this->picName+"\" alt=\"Image read error!\" height=\"128\" width=\"128\" />");
}
    ...
    bool halt = false;
        ...
        else
        {
            ...
            if(iQuery.exec())
            {
                ...
                ui->fBox->setText("");
                ui->lBox->setText("");
                ui->regLabel->setText("<img src=\":user.png\" />");
