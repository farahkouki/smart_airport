...
QRect PieView::itemRect(const QModelIndex &index) const
{
    ...
    //amel 3compteuret ou ywaliw yamlou control de saisie meli dkha lezm el nombre d invite ykoun ya >100 weala >200 wala >300
 //lena bech nrodha tekhou mel cas el jdida  baz bec twali el index.column
    if (index.column() != 1)
