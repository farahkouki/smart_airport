...
q1.prepare("SELECT ID FROM TABLE2");
q1.exec();

q2.prepare("SELECT ID FROM TABLE2 WHERE ID<5 ");
q2.exec();

q3.prepare("SELECT ID FROM TABLE2 WHERE ID>5");
q3.exec();

q4.prepare("SELECT ID FROM TABLE2 WHERE ID>15 ");
q4.exec();
...
//pie chart
    ...
    q4.prepare("SELECT ID FROM TABLE2 WHERE ID>10 ");
    q4.exec();
