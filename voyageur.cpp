...
voyageur::voyageur(int cin,QString nom,QString prenom)
{
    ...
    bool voyageur :: modifier1(int cin){
    ...
    bool voyageur::supprimer1(int cin){
        QSqlQuery query;
     ...
     QSqlQueryModel* voyageur::afficher0()
    {
    ...
    return model ;
     ...
     bool voyageur::rechercher1(int cin)
     {
